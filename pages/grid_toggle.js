...
function showRound(i) {
    for(let x = 1; x < 11; x++) {
        document.getElementById(`round${x}`).style.display = 'none';
        document.getElementById(`button${x}`).style.backgroundColor = '#975e6a';
    }
    document.getElementById(`round${i}`).style.display = 'grid';
    document.getElementById(`button${i}`).style.backgroundColor = '#c18794';
}
...
function showRound(roundNumber) {
    ...
    document.getElementById(`round${roundNumber}`).style.display = 'grid';
